define(['lib/news_special/bootstrap', 'lib/vendors/d3/topojson', 'backbone', 'models/map', 'views/mapWrapper', 'text!maps/wales.json'], function (news, Topojson, Backbone, MapModel, MapWrapper, mapTopoJson) {
